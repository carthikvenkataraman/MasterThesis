...
C = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/60/11/C.mat');
B(1) = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/60/11/U0B.mat');
% B(2) = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/60/11/U1B.mat');
% B(3) = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/60/11/U2B.mat');
% B(4) = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/60/11/U3B.mat');
...
for nYear=1:4     
    ...
    AxleLoads(1,:) = [7094, 11326/2*[1 1]];   
    AxleLoads(2,:) = 20100/3*[1 1 1];    
    AxleLoads(3,:) = 8000/2*[1 1 0];    
...
save('OutputsWithOtherGCWs/60/11/ProductivityFixedRevenue.mat');
...
saveas(gcf, 'PlotsProductivityWithOtherGCWs/60/11/MFORvsYearFixedRevenue.pdf');
...
set(gca,'XTick',[1 2 3 4]);
set(gca,'XTickLabel',{'2015','2020','2025', '2030'});
saveas(gcf, 'PlotsProductivityWithOtherGCWs/60/11/ProdvsYearFixedRevenue.pdf');
