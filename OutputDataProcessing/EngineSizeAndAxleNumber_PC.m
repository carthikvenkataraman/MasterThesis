...
fileNumber=[3,13,22,31,55;...   % D11 engine
            7,14,23,32,56;...   % D13 engine
            11,15,24,33,57];    % D16 engine
engineSize=[11,13,16];
...
% saveas(gcf,'PlotsWithPredictiveControl/EngineSizeAndNoOFAxles/MissionTimeVsAxleNumberAndEngineSize.pdf');
...
set(gca,'XTick',[1 2 3]);
set(gca,'XTickLabel',{'D11','D13','D16'});
% saveas(gcf,'PlotsWithPredictiveControl/EngineSizeAndNoOFAxles/FuelConsumptionVsAxleNumberAndEngineSize.pdf');
...
% saveas(gcf,'PlotsWithPredictiveControl/EngineSizeAndNoOFAxles/FuelConsumptionReductionVsAxleNumberAndEngineSize.pdf');
...
set(gca,'XTick',[1 2 3]);
set(gca,'XTickLabel',{'D11','D13','D16'});
% saveas(gcf,'PlotsWithPredictiveControl/EngineSizeAndNoOFAxles/CombinationStartabilityVsAxleNumberAndEngineSize.pdf');
...
for i=1:size(fileNumber,1)
    ...
    % saveas(gcf,strcat('PlotsWithPredictiveControl/EngineSizeAndNoOFAxles/',figureName,'.pdf'));
end
