...
filePath = strcat('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OptimalCombinationsOutputFilesRevised/',int2str(year),'/',gcwCode,int2str(fileCode),'D16/');
...
outputFilePath = strcat('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OptimalProductivityOutputs/',int2str(year),'/',gcwCode,int2str(fileCode),'D16.mat');
...
% Base combination
cFixedConv = sum(missionData.unitCosts)+missionData.powertrainPremium(2);
