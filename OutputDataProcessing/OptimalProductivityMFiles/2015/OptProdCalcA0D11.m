...
filePath = strcat('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OptimalCombinationsOutputFilesRevised/',int2str(year),'/',gcwCode,int2str(fileCode),'D11/');
...
outputFilePath = strcat('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OptimalProductivityOutputs/',int2str(year),'/',gcwCode,int2str(fileCode),'D11.mat');
