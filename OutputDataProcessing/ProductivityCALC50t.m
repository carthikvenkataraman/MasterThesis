...
C = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/50/57/C.mat');
B(1) = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/50/57/U0B.mat');
B(2) = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/50/57/U1B.mat');
B(3) = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/50/57/U2B.mat');
B(4) = load('/home/karthik/Documents/GitHubRepos/MasterThesis-PropOpt/OutputDataProcessing/OutputsWithOtherGCWs/50/57/U3B.mat');
...
for nYear=1:4     
    ...
    AxleLoads(1,:) = [7094, 10986/2*[1 1]];   
    AxleLoads(2,:) = 15100/3*[1 1 1];    
    AxleLoads(3,:) = 7000/2*[1 1 0];    
    AxleLoads(4,:) = 10000/3*[1 1 1];   
...
save('OutputsWithOtherGCWs/50/57/ProductivityFixedRevenue.mat');
...
saveas(gcf, 'PlotsProductivityWithOtherGCWs/50/57/MFORvsYearFixedRevenue.pdf');
...
set(gca,'XTick',[1 2 3 4]);
set(gca,'XTickLabel',{'2015','2020','2025', '2030'});
saveas(gcf, 'PlotsProductivityWithOtherGCWs/50/57/ProdvsYearFixedRevenue.pdf');
