...
% User commands
\title{Propulsion Optimisation in Long Vehicle Combinations}
\subtitle{A Stochastic Optimisation Approach to Concept Selection} % Optional
\author{Karthik Venkataraman\and Nikhil Acharya}
\thesisin{Vehicle Engineering and Autonomous Systems}
...
\keywords{Long combinations trucks, propulsion, longitudinal dynamics, stochastic optimisation, genetic algorithms}
