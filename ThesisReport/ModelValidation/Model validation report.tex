...
\begin{figure}[h!]
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Figures/Engine_size_and_GCW/MissionSpeed80tZoomed.png}
		\caption{D11 has significantly lower average speeds}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=\linewidth]{Figures/Engine_size_and_GCW/MissionSpeed80tZoomedMaxGradient.png}
...
\begin{subfigure}{.5\textwidth}
	\centering
	\includegraphics[width=\linewidth]{Figures/Increasing_number_of_axles/Speed_vs_position_zoomed_no_of_axles_begin_dec.png}
	\caption{Vehicle speed at the beginning of Hallands\aa sen}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
	\centering
	\includegraphics[width=\linewidth]{Figures/Increasing_number_of_axles/Speed_vs_position_zoomed_no_of_axles_peak.png}
