...
\section{Vehicle productivity as a function of added propulsion}
	...
	\begin{table}[H]
		\caption{Configurations with increasing propulsion}
		\centering
		\begin{tabular}{c c}
		\hline\hline
		Configuration name & Configuration Description \\  
		\hline
		Combination A & \begin{tikzpicture}[ scale=0.3]
				% Tractor
				\draw (7.5,2) rectangle (10,5);
				\draw[fill=red] (8.25,2) rectangle (9.25,2.5);
				\draw[fill=red] (8.25,2.5) rectangle (9.25,3);
		...
		Combination B & \begin{tikzpicture}[ scale=0.3]
				% Tractor
				\draw (7.5,2) rectangle (10,5);
				\draw[fill=red] (8.25,2) rectangle (9.25,2.5);
				\draw[fill=red] (8.25,2.5) rectangle (9.25,3);
		...
		Combination C & \begin{tikzpicture}[ scale=0.3]
				% Tractor
				\draw (7.5,2) rectangle (10,5);
				\draw[fill=red] (8.25,2) rectangle (9.25,2.5);
				\draw[fill=red] (8.25,2.5) rectangle (9.25,3);
		...
		Combination D & \begin{tikzpicture}[ scale=0.3]
			% Tractor
			\draw (7.5,2) rectangle (10,5);
			\draw[fill=red] (8.25,2) rectangle (9.25,2.5);
			\draw[fill=red] (8.25,2.5) rectangle (9.25,3);
			...
			% \draw (25.5,1) rectangle (26.5,1.5);
			% \draw (25.5,1.5) rectangle (26.5,2);
			\draw[fill=green!100] (27.5,1) circle (0.8);
			\draw (27.5,1) circle (0.6);
			\draw (27.5,1) circle (0.4);	
			\draw[fill=green!100] (29.5,1) circle (0.8);
			\draw (29.5,1) circle (0.6);
		...
		Combination E & \begin{tikzpicture}[ scale=0.3]
			% Tractor
			\draw (7.5,2) rectangle (10,5);
			\draw[fill=red] (8.25,2) rectangle (9.25,2.5);
			\draw[fill=red] (8.25,2.5) rectangle (9.25,3);
		...
		Combination F & \begin{tikzpicture}[ scale=0.3]
			% Tractor
			\draw (7.5,2) rectangle (10,5);
			\draw[fill=red] (8.25,2) rectangle (9.25,2.5);
			\draw[fill=red] (8.25,2.5) rectangle (9.25,3);
		...
		\hline
		\end{tabular}
		\label{table:CombIncProp}
	\end{table}

	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth, clip=true, trim=45 225 45 260]{figures/Results/GCW50.pdf}
		\caption{Variation of vehicle productivity with increasing propulsion - GCW 50t}
		\label{prodPropGCW50}
	\end{figure}

	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth, clip=true, trim=45 225 45 260]{figures/Results/GCW60.pdf}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth, clip=true, trim=45 225 45 260]{figures/Results/GCW70.pdf}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth, clip=true, trim=45 225 45 260]{figures/Results/GCW80.pdf}
...
\section{Optimal Combinations for increasing GCWs}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\textwidth, clip=true, trim=45 205 125 208]{figures/OptimalCombinationResults/2015/Productivity.pdf}
...
\section{Optimal Combinations for constant GCW over the years}
	...
	\begin{figure}[ht!]
		\centering
		\includegraphics[width=0.5\textwidth, clip=true, trim=45 205 125 208]{figures/OptimalCombinationResults/SingleGCW/A/Productivity.pdf}
