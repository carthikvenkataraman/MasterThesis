...
% User commands
\title{Optimisation of  Propulsion Configuration in Truck-Trailer Combinations - An Evolutionary Algorithm Approach}
%\subtitle{Volvo Group Trucks Technology, Go\"teborg, Sweden} % Optional
