...
\chapter{Mission Productivity}
	...
	\section{Productivity formulation}
		...
		\subsection{Fixed costs}
			...
			\end{equation}
			\nomenclature{$P_{batt,i}$}{Buffer price, unit i \euro} \nomenclature{$N_{eAxle,i}$}{Number of propelled axles on specified unit} \nomenclature{$P_{eAxle,j}$}{Price of electrification of a single axle \euro} The battery price for a single unit i, $P_{batt,i}$, is expressed as
			\begin{equation}
